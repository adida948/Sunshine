...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            //Sent the zipcode to lookup 7 day forecast
             weatherTask.execute("10031");
            return true;
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            //If there is no zipcode, there is nothing to look up. Verift siZe of param
            if (params.length == 0) {
                return null;
            }
            ...
            // Variables to form the requested URL
            String format = "json";
            String unis = "metric";
            int numDays = 7;
            ...
            try {
                ...
                //Construct the URL to fetch forecast data.
